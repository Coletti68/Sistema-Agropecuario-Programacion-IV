Dependencias instaladas hasta el momento:

- *express*: Framework minimalista para crear el servidor y manejar rutas HTTP.
- *sequelize*: ORM que facilita la interacción con la base de datos MySQL mediante modelos.
